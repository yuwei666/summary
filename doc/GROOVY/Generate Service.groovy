package com.ccb.cloud.simis.accountability.approval.dao
...
def generate(out, className, fields,table) {
    ...
    out.println ""
    out.println "/**\n" +
            " * @Description " + table.getComment()+"Service Interface\n" +
            " * @Author  yuwei\n" +
    ...
    out.println "\tCommonOutVo findOne(TxRequestMsg msg);\n"

    out.println "\tCommonOutVo save(TxRequestMsg msg);\n"

    out.println "\tCommonOutVo list(TxRequestMsg msg);\n"

    out.println "\tCommonOutVo delete(TxRequestMsg msg);\n"
